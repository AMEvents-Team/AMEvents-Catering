        ...
        <div className="mt-24 text-center">
          ...
          <div className="mx-auto max-w-5xl rounded-3xl border border-white/30 bg-white/20 backdrop-blur-2xl p-10 shadow-[0_20px_60px_rgba(212,175,160,0.4)] relative overflow-hidden">
            ...
            <p className="text-[#7D6A58] leading-relaxed mb-10 relative z-10">
              {t(
                "Së shpejti sjellim një eksperiencë krejtësisht të re për eventet tuaja: ftesa digjitale elegante dhe një sistem unik ku mysafirët mund të skanojnë QR code gjatë eventit për të bërë foto. Të gjitha fotot mblidhen automatikisht dhe krijojnë një album digjital të përbashkët për kujtime të paharrueshme.",
