...
const BookingSection = () => {
  ...
  return (
    <section id="booking" className="bg-white py-20 sm:py-32">
      <div ref={ref} className="section-reveal mx-auto max-w-2xl px-4 sm:px-6">
        ...
        <form onSubmit={handleSubmit} className="glass-card space-y-5 p-5 sm:p-8 w-full">
          ...
          <div className="relative">
            <input
              ...
              className="peer w-full rounded-xl border border-[#E8D8C3]/60 bg-[#E8D8C3]/30 px-4 pt-6 pb-2 font-body text-sm text-[#6F5B4B] placeholder-transparent backdrop-blur-sm sm:backdrop-blur-md transition-all focus:border-[#C6A77D] focus:outline-none focus:ring-1 focus:ring-[#C6A77D]/30"
              placeholder=" "
            />
            <label className="absolute left-4 top-2 text-xs text-[#C6A77D] transition-all duration-200
          ...
          <div className="relative">
            <input
              ...
              className="w-full appearance-none rounded-xl border border-[#E8D8C3]/60 bg-[#E8D8C3]/30 px-4 pt-6 pb-2 font-body text-sm text-[#6F5B4B] backdrop-blur-sm sm:backdrop-blur-md transition-all focus:border-[#C6A77D] focus:outline-none focus:ring-1 focus:ring-[#C6A77D]/30"
            />
          ...
          <div className="relative">
            <select
              ...
              className="w-full rounded-xl border border-[#E8D8C3]/60 bg-[#E8D8C3]/30 px-4 pt-6 pb-2 font-body text-sm text-[#6F5B4B] backdrop-blur-sm sm:backdrop-blur-md transition-all focus:border-[#C6A77D] focus:outline-none focus:ring-1 focus:ring-[#C6A77D]/30"
            >
          ...
          <div className="relative">
            <textarea
              ...
              className="peer w-full rounded-xl border border-[#E8D8C3]/60 bg-[#E8D8C3]/30 px-4 pt-6 pb-2 font-body text-sm text-[#6F5B4B] placeholder-transparent backdrop-blur-sm sm:backdrop-blur-md transition-all focus:border-[#C6A77D] focus:outline-none focus:ring-1 focus:ring-[#C6A77D]/30 resize-none"
              placeholder=" "
            />
            <label className="absolute left-4 top-2 text-xs text-[#C6A77D] transition-all duration-200
              peer-placeholder-shown:top-3.5
        ...
        {showSuccess && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
            <div className="rounded-3xl border border-white/30 bg-white/90 backdrop-blur-xl shadow-2xl mx-4 max-w-md animate-fade-up p-8 sm:p-10 text-center">
